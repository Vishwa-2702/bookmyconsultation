...
public class DoctorService {
	...
	/** register is for allow the admin to register doctors to the application**/
	...
	/** getDoctor is for to returns doctor details after getting the doctor id as the input**/
