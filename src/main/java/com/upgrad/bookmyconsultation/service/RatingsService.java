...
public class RatingsService {
	...
	/**	SubmitRatings is for save the doctor ratings in the ratings table as well as calculate and update the new average rating (in the doctor table) when a new rating is submitted for that specific doctor. **/
